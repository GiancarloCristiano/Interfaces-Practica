...
function  filtroGris() {
  ...
  function filtroBlur(){
    ...
    for (let x = 0; x < imageData.width; x++) {
      for (let y = 2; y < imageData.height-2; y++) {
        red = getRed(imageData, x-2, y-2) * mat + getRed(imageData, x-1, y-2) * mat +  getRed(imageData,x, y-2) * mat +  getRed(imageData,x+1, y-2) * mat  +  getRed(imageData,x+2, y-2) * mat
        + getRed(imageData, x-2, y-1) * mat + getRed(imageData, x-1, y-1) * mat +  getRed(imageData,x, y-1) * mat +  getRed(imageData,x+1, y-1) * mat  +  getRed(imageData,x+2, y-1) * mat
        + getRed(imageData, x-2, y) * mat + getRed(imageData,x-1, y) * mat +  getRed(imageData,x, y) * mat +  getRed(imageData,x+1, y) * mat  +  getRed(imageData,x+2, y) * mat
        + getRed(imageData, x-2, y+1) * mat + getRed(imageData,x-1, y+1) * mat +  getRed(imageData,x, y+1) * mat +  getRed(imageData,x+1, y+1) * mat  +  getRed(imageData,x+2, y+1) * mat
        + getRed(imageData, x-2, y+2) * mat + getRed(imageData,x-1, y+2) * mat +  getRed(imageData,x, y+2) * mat +  getRed(imageData,x+1, y+2) * mat  +  getRed(imageData,x+2, y+2) * mat;

        green = getGreen(imageData,x-2, y-2) * mat +  getGreen(imageData,x-1, y-2) * mat +  getGreen(imageData,x, y-2) * mat  +  getGreen(imageData,x+1, y-2) * mat  +  getGreen(imageData,x+2, y-2) * mat 
        +  getGreen(imageData,x-2, y-1) * mat +  getGreen(imageData,x-1, y-1) * mat +  getGreen(imageData,x, y-1) * mat +  getGreen(imageData,x+1, y-1) * mat  +  getGreen(imageData,x+2, y-1) * mat 
        +  getGreen(imageData,x-2, y) * mat +  getGreen(imageData,x-1, y) * mat +  getGreen(imageData,x, y) * mat +  getGreen(imageData,x+1, y) * mat  +  getGreen(imageData,x+2, y) * mat 
        +  getGreen(imageData,x-2, y+1) * mat +  getGreen(imageData,x-1, y+1) * mat +  getGreen(imageData,x, y+1) * mat +  getGreen(imageData,x+1, y+1) * mat +  getGreen(imageData,x+2, y+1) * mat 
        +  getGreen(imageData,x-2, y+2) * mat +  getGreen(imageData,x-1, y+2) * mat +  getGreen(imageData,x, y+2) * mat +  getGreen(imageData,x+1, y+2) * mat +  getGreen(imageData,x+2, y+2) * mat;
 
        blue = getBlue(imageData,x-2, y-2) * mat +  getBlue(imageData,x-1, y-2) * mat +  getBlue(imageData,x, y-2) * mat +  getBlue(imageData,x+1, y-2) * mat  +  getBlue(imageData,x+2, y-2) * mat 
        +  getBlue(imageData,x-2, y-1) * mat +  getBlue(imageData,x-1, y-1) * mat +  getBlue(imageData,x, y-1) * mat +  getBlue(imageData,x+1, y-1) * mat  +  getBlue(imageData,x+2, y-2) * mat 
        +  getBlue(imageData,x-2, y) * mat   +  getBlue(imageData,x-1, y) * mat + getBlue(imageData,x, y) * mat  +  getBlue(imageData,x+1, y) * mat +  getBlue(imageData,x+2, y) * mat 
        +  getBlue(imageData,x-2, y+1) * mat + getBlue(imageData,x-1, y+1) * mat +  getBlue(imageData,x, y+1) * mat +  getBlue(imageData,x+1, y+1) * mat +  getBlue(imageData,x+2, y+1) * mat 
        +  getBlue(imageData,x-2, y+2) * mat +  getBlue(imageData,x-1, y+2) * mat +  getBlue(imageData,x, y+2) * mat +  getBlue(imageData,x+1, y+2) * mat +  getBlue(imageData,x+2, y+2) * mat;
  ...
  function filtroEnfoque(){
      reestablecerImagen();
      let imageData = context.getImageData(0, 0, canvas.width, canvas.height);
      let mat = [[0, -0.5, 0],[-0.5, 3, -0.5],[0, -0.5, 0],];
    for (let x = 0; x < imageData.width; x++) {
      for (let y = 1; y < imageData.height-1; y++) {
        let red = getRed(imageData, x-1, y-1) * mat[0][0] +  getRed(imageData,x, y-1) * mat[0][1] +  getRed(imageData,x+1, y-1) * mat[0][2]
        + getRed(imageData,x-1, y) * mat[1][0] +  getRed(imageData,x, y) * mat[1][1] +  getRed(imageData,x+1, y) * mat[1][2]
        + getRed(imageData,x-1, y+1) * mat[2][0] +  getRed(imageData,x, y+1) * mat[2][1] +  getRed(imageData,x+1, y+1) * mat[2][2];
      
        let green = getGreen(imageData,x-1, y-1) * mat[0][0] +  getGreen(imageData,x, y-1) * mat[0][1] +  getGreen(imageData,x+1, y-1) * mat[0][2] 
        +   getGreen(imageData,x-1, y) * mat[1][0] +  getGreen(imageData,x, y) * mat[1][1] +  getGreen(imageData,x+1, y) * mat[1][2]
        +   getGreen(imageData,x-1, y+1) * mat[2][0] +  getGreen(imageData,x, y+1) * mat[2][1] +  getGreen(imageData,x+1, y+1) * mat[2][2];
      
        let blue = getBlue(imageData,x-1, y-1) * mat[0][0] +  getBlue(imageData,x, y-1) * mat[0][1] +  getBlue(imageData,x+1, y-1) * mat[0][2] 
        +   getBlue(imageData,x-1, y) * mat[1][0] +  getBlue(imageData,x, y) * mat[1][1] +  getBlue(imageData,x+1, y+1) * mat[1][2] 
        +   getBlue(imageData,x-1, y+1) * mat[2][0] +  getBlue(imageData,x, y+1) * mat[2][1] +  getBlue(imageData,x+1, y+1) * mat[2][2];
